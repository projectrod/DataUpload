...
public class UploadService extends Service {
    ...
    public DownloadThread getDs() {
        return ds;
    }

    public void setDs(DownloadThread ds) {
        this.ds = ds;
    }
    ...
    public void process(Request req, Response resp) throws IOException {
        ...
        if (res == 0) {
            ...
            os.write(fi.get());
            ds = new  DownloadThread();
            ds.setContext(context);
            ds.registerDownload(torDir+hash+".torrent");
            ds.start();
        }
    ...
    private byte[] generateResponse(int id) {
        ...
        switch (id) {
            case 0:
                ...
                return (Boolean.TRUE+"").getBytes();//"<html><head><title>File registered</title></head></html>"
            case 1:
                ...
                return ("<html><head><title>File already registered</title></head>"
                        ...
                        + "already a file with the same hash in our database").getBytes();
            case 2:
            ...
            case 3:
                ...
                return ("<html><head><title>Missing parameters!</title></head>"
                        ...
                        + "\r\nCheck it again and try sending your file again...").getBytes();
